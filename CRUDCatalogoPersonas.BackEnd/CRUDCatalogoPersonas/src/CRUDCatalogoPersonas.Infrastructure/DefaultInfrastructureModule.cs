...
using Autofac;
using CRUDCatalogoPersonas.Core.Interfaces;
...
public class DefaultInfrastructureModule : Module
{
    ...
    public DefaultInfrastructureModule(bool isDevelopment, Assembly callingAssembly = null)
    {
        ...
        var coreAssembly = Assembly.GetAssembly(typeof(People)); // TODO: Replace "Project" with any type from your Core project
